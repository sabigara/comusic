...
const MuteSoloButton: React.FC<Props> = ({
  muteOn,
  soloOn,
  onMuteClick,
  onSoloClick,
...
const Mute = styled(Button)`
  ...
  background-color: ${(props) =>
    props.isEnabled ? Color.Button.MuteOn : Color.Button.Disabled};
`;
...
const Solo = styled(Button)`
  ...
  background-color: ${(props) =>
    props.isEnabled ? Color.Button.SoloOn : Color.Button.Disabled};
`;
